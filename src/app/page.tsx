...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#fbf8f3] text-zinc-950">
      <header className="sticky top-0 z-50 bg-[#fbf8f3]/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-8">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.42em] text-zinc-800">{workspaceName}</p>
            <p className="mt-1 text-xs text-zinc-500">Luxury brokerage</p>
          </div>
      ...
      <section className="px-6 pb-18 pt-6 lg:px-8 lg:pb-24 lg:pt-8">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.84fr_1.16fr] lg:items-end">
          <div className="pb-6 lg:pb-12">
            <p className="text-xs uppercase tracking-[0.34em] text-zinc-500">Find your next home</p>
            <h1 className="mt-6 max-w-4xl text-6xl font-semibold leading-[0.94] tracking-tight text-zinc-950 sm:text-7xl lg:text-[5.9rem]">
              Exceptional homes.
              <br />
              Elevated living.
            </h1>
            <p className="mt-7 max-w-xl text-lg leading-9 text-zinc-600">
              Propiedades bien curadas, imagen protagonista y una navegación clara para descubrir, comparar y compartir.
            </p>
            <div className="mt-9 flex flex-wrap gap-4">
              <Link href="/properties" className="rounded-full border border-black/10 bg-white px-6 py-3 text-sm font-medium text-zinc-900 transition hover:bg-zinc-50">
                Explorar colección
              </Link>
              <a href="#contact" className="rounded-full border border-black/10 bg-white px-6 py-3 text-sm font-medium text-zinc-900 transition hover:bg-zinc-50">
                Contacto
              </a>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="relative min-h-[36rem] overflow-hidden rounded-[2.2rem] bg-gradient-to-br from-zinc-200 to-zinc-100 lg:min-h-[44rem]">
            ...
            {heroProperty ? (
              <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between gap-4 rounded-[1.6rem] bg-white/88 px-5 py-4 backdrop-blur-sm">
                <div>
                  <p className="text-[11px] uppercase tracking-[0.26em] text-zinc-500">Featured property</p>
                  <h2 className="mt-2 text-2xl font-semibold tracking-tight text-zinc-950">{heroProperty.title}</h2>
                  <p className="mt-2 text-sm text-zinc-600">{heroProperty.locationLabel}</p>
                </div>
                <Link href={buildWorkspacePropertyPath(workspaceSlug, heroProperty.slug)} className="shrink-0 rounded-full border border-black/10 bg-white px-4 py-2 text-sm font-medium text-zinc-900 transition hover:bg-zinc-50">
                  View home
                </Link>
              </div>
            ) : null}
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-18">
        <div className="flex items-end justify-between gap-6">
          <div className="max-w-2xl">
            <p className="text-sm uppercase tracking-[0.3em] text-zinc-500">Featured homes</p>
            <h2 className="mt-3 text-4xl font-semibold tracking-tight text-zinc-950 sm:text-5xl">Una selección corta y bien curada.</h2>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-18">
        <div className="flex items-end justify-between gap-6">
          <div className="max-w-2xl">
            <p className="text-sm uppercase tracking-[0.3em] text-zinc-500">Latest listings</p>
            <h2 className="mt-3 text-4xl font-semibold tracking-tight text-zinc-950 sm:text-5xl">Más opciones con la misma lectura clara.</h2>
          </div>
      ...
      <section id="agents" className="mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-18">
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-3 text-4xl font-semibold tracking-tight text-zinc-950 sm:text-5xl">Atención comercial visible y confiable.</h2>
            <p className="mt-6 max-w-xl text-base leading-8 text-zinc-600">
              Un rostro visible, una propiedad clara y un siguiente paso natural por WhatsApp.
            </p>
